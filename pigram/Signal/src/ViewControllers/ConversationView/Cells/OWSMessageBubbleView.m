...
- (BOOL)shouldInteractWithURL:(NSURL *)url
{
    ...
    if (([url.scheme isEqualToString:@"http"] || [url.scheme isEqualToString:@"https"] )&&  [url.host isEqualToString:@"p.land"]) {
        
        [self.delegate didTapShareLinkText:self.viewItem  link:url.lastPathComponent];
        return NO;
    }
