...
#pragma mark -- carrot begin 新增
+ (nullable ECKeyPair *)txInitWithPublicKey:(nullable NSData *)publicKey withPrivateKey:(nullable NSData *)privateKey{
    if (privateKey == nil || publicKey == nil) {
        return  nil;
    }
    return  [[ECKeyPair alloc]initWithPublicKey:publicKey privateKey:privateKey];
}
#pragma mark -- carrot end 新增
